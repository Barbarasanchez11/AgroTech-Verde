        ...
        with st.spinner("Procesando predicción..."):
            ...
            if isinstance(prediction_result, tuple) and len(prediction_result) >= 2:
                ...
                if success:
                    ...
                    st.success(f"**Predicción exitosa:** {crop.capitalize()}")
                    ...
                    <div style="
                        ...
                        margin: 15px 0;
                    ">
                        <h5 style="color: #155724; margin: 0 0 10px 0;">**Resultado de la predicción:**</h5>
                        <ul style="color: #155724; margin: 0; padding-left: 20px;">
                            <li>Cultivo recomendado: <strong>{crop.capitalize()}</strong></li>
